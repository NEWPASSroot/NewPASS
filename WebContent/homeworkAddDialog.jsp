		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-content">
				<div class="modal-header" style="padding: 35px 50px;">
					<h5 class="mdoal-title">新增作業資訊</h5>
				...
				<div class="modal-body" style="padding: 40px 50px;">
					<form role="form" action="python.jsp" method="post">
						...
						<div class="form-group">
							<label for="add_homework_deadline"> 繳交期限</label> <input type="datetime"
								class="form-control" id="add_homework_deadline"
								name="homework_deadline" required="required">
						</div>
						<div class="form-group">
