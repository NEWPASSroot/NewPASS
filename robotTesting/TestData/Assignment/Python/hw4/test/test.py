...
class InnerProductTestSuite(unittest.TestCase):
    ...
    def testGetVectorNormal(self):
        self.assertEqual(VectorInput.getVector("( 1, 2)"), [1, 2])

    def testGetVectorException(self):
        self.assertEqual(VectorInput.getVector(""), "Input is empty")
        self.assertEqual(VectorInput.getVector("()"), "Input is empty")
        self.assertEqual(VectorInput.getVector("(2 (, 3))"), "Invalid input")
        self.assertEqual(VectorInput.getVector("2, 3)"), "Invalid input")
        self.assertEqual(VectorInput.getVector("(, 3)"), "Invalid input")
        self.assertEqual(VectorInput.getVector("(2 a, 3)"), "Invalid input")
