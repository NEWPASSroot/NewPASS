...
public class HomeworkUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String submitDatetime = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm").format(Calendar.getInstance().getTime());
		...
		if (studentId != null) {
			...
			if (id == 0) {
				submitHomeworkDBHelper.insertHomework(teacherAssignmentId, studentId, submitDatetime, homeworkFileName,
						inputStream);
			} else {
